...
{ config, pkgs, lib, deviceSettings, deviceUserSettings, ... }:
{
 ...
 imports = [
  ...
  # manage.
  home.username = deviceSettings.user;
  home.homeDirectory = "/home/" + deviceSettings.user;
  ...
  home.packages = [
    pkgs.libinput
    # C# Adds the 'hello' command to your environment. It prints a friendly
